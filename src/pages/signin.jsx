					...
					<div className='bg-white p-8 rounded-lg w-full md:w-[500px]'>
						...
						<div className='flex flex-col justify-center items-start space-x-4 gap-4 mt-4'>
							<button className=' text-[#141414]  border border-[#141414]/20 w-full justify-center font-semibold py-3 px-4 rounded-md flex items-center space-x-2 m-0 focus:outline-none '>
								<img src='/assets/images/Gmail.png' alt='Logo' width={22} height={70} className=' ' />
								<span>Continue with Google</span>
							</button>
							<button className=' text-[#141414] border border-[#141414]/20 w-full justify-center font-semibold py-3 px-4 rounded-md flex items-center space-x-2 m-0 focus:outline-none '>
								<img src='/assets/images/Facebook svg.png' alt='Logo' width={22} height={70} className=' mr-2' />
						...
						<form onSubmit={handleSubmit(onSubmit)} className='mt-4'>
							...
							<div className='flex w-full justify-between items-center'>
								<Link to='/screenrecorder' className='text-[#120B48] w-full text-sm font-semibold'>
