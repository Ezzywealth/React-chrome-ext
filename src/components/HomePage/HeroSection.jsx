		...
		<div id='home' className=' py-32  flex flex-col-reverse justify-center lg:flex-row items-center px-4 lg:px-16 xl:px-48'>
			...
			<div className='w-full lg:w-1/2 grid grid-cols-2 gap-6'>
				<section className='flex flex-col justify-between relative'>
					<img src='/assets/images/stage5_1.png' width={500} height={500} alt='Hero 1' className='w-full h-auto rounded-[8px]' />
					<img src='/assets/images/stage5_2.png' width={500} height={500} alt='Hero 2' className='w-full h-auto rounded-[8px]' />
					<img src='/assets/images/frame2.png' width={400} height={500} alt='Hero 3' className='w-full h-auto rounded-[8px] absolute -bottom-[70px] -left-[50px] -z-30' />
				</section>
				<section className='relative'>
					<img src='/assets/images/stage5_3.png' width={400} height={500} alt='Hero 3' className='w-full h-auto rounded-[8px]' />
					<img src='/assets/images/frame.png' width={400} height={500} alt='Hero 3' className='w-full h-auto rounded-[8px] absolute -top-[57px] -right-[50px] -z-30' />
				</section>
			</div>
		</div>
	);
